# Phase 10 Documentation: research-memory

This document formally specifies the behavioral and architectural constraints of the research-memory mechanism in Phase 10 External Intelligence.
