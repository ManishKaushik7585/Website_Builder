# Phase 10 Documentation: caching

This document formally specifies the behavioral and architectural constraints of the caching mechanism in Phase 10 External Intelligence.
