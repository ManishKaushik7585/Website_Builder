# Phase 10 Documentation: web-research

This document formally specifies the behavioral and architectural constraints of the web-research mechanism in Phase 10 External Intelligence.
