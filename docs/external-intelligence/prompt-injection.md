# Phase 10 Documentation: prompt-injection

This document formally specifies the behavioral and architectural constraints of the prompt-injection mechanism in Phase 10 External Intelligence.
