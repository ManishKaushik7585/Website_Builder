# Phase 10 Documentation: design-patterns

This document formally specifies the behavioral and architectural constraints of the design-patterns mechanism in Phase 10 External Intelligence.
