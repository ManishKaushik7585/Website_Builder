# Phase 10 Documentation: api-contracts

This document formally specifies the behavioral and architectural constraints of the api-contracts mechanism in Phase 10 External Intelligence.
