# Phase 10 Documentation: uncertainty

This document formally specifies the behavioral and architectural constraints of the uncertainty mechanism in Phase 10 External Intelligence.
