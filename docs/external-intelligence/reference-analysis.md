# Phase 10 Documentation: reference-analysis

This document formally specifies the behavioral and architectural constraints of the reference-analysis mechanism in Phase 10 External Intelligence.
