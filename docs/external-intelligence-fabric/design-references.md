# Phase 11 Documentation: design-references

This document formally specifies the behavioral and architectural constraints of the design-references mechanism in Phase 11 External Intelligence Fabric.
