# Phase 11 Documentation: security-boundaries

This document formally specifies the behavioral and architectural constraints of the security-boundaries mechanism in Phase 11 External Intelligence Fabric.
