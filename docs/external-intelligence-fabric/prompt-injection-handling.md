# Phase 11 Documentation: prompt-injection-handling

This document formally specifies the behavioral and architectural constraints of the prompt-injection-handling mechanism in Phase 11 External Intelligence Fabric.
