# Phase 11 Documentation: mcp-security

This document formally specifies the behavioral and architectural constraints of the mcp-security mechanism in Phase 11 External Intelligence Fabric.
