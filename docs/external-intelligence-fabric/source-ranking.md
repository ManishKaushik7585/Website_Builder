# Phase 11 Documentation: source-ranking

This document formally specifies the behavioral and architectural constraints of the source-ranking mechanism in Phase 11 External Intelligence Fabric.
