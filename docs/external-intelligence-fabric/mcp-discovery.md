# Phase 11 Documentation: mcp-discovery

This document formally specifies the behavioral and architectural constraints of the mcp-discovery mechanism in Phase 11 External Intelligence Fabric.
