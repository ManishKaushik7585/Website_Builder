# Phase 11 Documentation: architecture

This document formally specifies the behavioral and architectural constraints of the architecture mechanism in Phase 11 External Intelligence Fabric.
