# Phase 11 Documentation: provenance

This document formally specifies the behavioral and architectural constraints of the provenance mechanism in Phase 11 External Intelligence Fabric.
