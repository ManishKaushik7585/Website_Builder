# Phase 11 Documentation: tool-selection

This document formally specifies the behavioral and architectural constraints of the tool-selection mechanism in Phase 11 External Intelligence Fabric.
